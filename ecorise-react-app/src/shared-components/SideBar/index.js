...
const Sidebar = () => {
  ...
  return (
    <div className="sidebar">
      ...
      <ul>
  <li className={`sidebar-item${currentPage === "Home" ? " active" : ""}`}
      onClick={() => setCurrentPage("Home")}
  >
    <FaHome className="icon"/> <span className="nav-text">Home</span>
  </li>
  <li className={`sidebar-item${currentPage === "Pick-up" ? " active" : ""}`}
      onClick={() => setCurrentPage("Pick-up")}
  >
    <FaTruck className="icon"/> <span className="nav-text">Pick up</span>
  </li>
  <li className={`sidebar-item${currentPage === "Inventory" ? " active" : ""}`}
  ...
  <li className={`sidebar-item${currentPage === "Payment" ? " active" : ""}`}
